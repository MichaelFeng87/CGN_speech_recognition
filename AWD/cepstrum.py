...
def get_mfcc (input_data,alpha,nfilters,windowsize,frameshift,filt):
    #sampling frequency
    fs=input_data[0]
    ...
    mfcc = numpy.concatenate([mfcc,energy[:,None]],1)
    #plt.plot(xf,numpy.log10(x))
    # add delta and double delta features
