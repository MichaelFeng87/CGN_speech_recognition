...
load=False
# open the data file
data_loc= '/data/processed/fbanks.h5'
...
def build_dnn(input_var=None):
    ...
    network = lasagne.layers.InputLayer(shape=(None, 1, 11, 65),
                                        input_var=input_var)
   ...
   #        nonlinearity=lasagne.nonlinearities.rectify)
    ...
    #block 1   
    network = lasagne.layers.Conv2DLayer(network,num_filters=64,filter_size=(3,3),stride=(1,1),pad='same',W=lasagne.init.GlorotUniform(),nonlinearity=lasagne.nonlinearities.rectify)
    network = lasagne.layers.Conv2DLayer(network,num_filters=64,filter_size=(3,3),stride=(1,1),pad='same',W=lasagne.init.GlorotUniform(),nonlinearity=lasagne.nonlinearities.rectify)
    network = lasagne.layers.MaxPool2DLayer(network,pool_size=(1,2),stride=(1,2),ignore_border=True)
   
    #block 2
    network = lasagne.layers.Conv2DLayer(network,num_filters=128,filter_size=(3,3),stride=(1,1),pad='same',W=lasagne.init.GlorotUniform(),nonlinearity=lasagne.nonlinearities.rectify)
    network = lasagne.layers.Conv2DLayer(network,num_filters=128,filter_size=(3,3),stride=(1,1),pad='same',W=lasagne.init.GlorotUniform(),nonlinearity=lasagne.nonlinearities.rectify)
    network = lasagne.layers.MaxPool2DLayer(network,pool_size=(1,2),stride=(1,2),ignore_border=True)
    ...
    #block 4
    network = lasagne.layers.Conv2DLayer(network,num_filters=256,filter_size=(3,3),stride=(1,1),pad='same',W=lasagne.init.GlorotUniform(),nonlinearity=lasagne.nonlinearities.rectify)
    network = lasagne.layers.Conv2DLayer(network,num_filters=256,filter_size=(3,3),stride=(1,1),pad='same',W=lasagne.init.GlorotUniform(),nonlinearity=lasagne.nonlinearities.rectify)
    network = lasagne.layers.MaxPool2DLayer(network,pool_size=(2,2),stride=(2,2),ignore_border=True)
